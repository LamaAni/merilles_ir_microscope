...
% "cosine" wave obatined by integration of the sinewave assigned to
channel
% #3.
...
if cType == "LAN"
 ...
 connPar = pxiSlot; % Your slot # here, o for manual
selection
end
...
% end
 ...
 % Segment # processing
 % All Proteus models except the P908X share the same waveformmemory
 % bank among channel N+1 and N+2, N=0..NumOfChannels/2. This meansthat
 % the same segment number cannot be used for this pair ofchannels. In
 % this case the designated segment is used for the odd numbered
 % channels and the next segment is assigned to the even numberedchannel
